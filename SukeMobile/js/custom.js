...
$(document).ready(function() {
	...
	*/
	...
	$('.open-left').click(function() {
        $('.page-header').toggleClass('page-header-right');
    ...
    $('#content, .snap-content, .content, .container, .sidebar-logo-close').click(function(){
        ...
        $('.page-header').removeClass('page-header-left');
        $('.page-header').removeClass('page-header-right');
        snapper.close();
    });
...
//alert("content width:" + $("#content").width() + "index_img: width:" + $("  #index_img").width() + "index_img: height:" + $("#index_img").height());
...
window.addEventListener("resize", function() {
	...
	var w = $("#content").width();
	var img_w = $("#index_img").width();
	var img_h = $("#index_img").height();
	//alert("content width:" + $("#content").width() + "index_img: width:" + $("  #index_img").width() + "index_img: height:" + $("#index_img").height());
	if(img_w>w){
		var height = (w*img_h)/img_w;
		$("#index_img").css({"width":w,"height":height});
	}
