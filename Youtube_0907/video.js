// 單頁顯示的資料筆數
    ...
    const app = Vue.createApp({
		data(){
			...
			created () {
				fetch('https://www.googleapis.com/youtube/v3/videos?part=snippet,id,contentDetails&chart=mostPopular&maxResults=100&key=AIzaSyC8Dq2_fJ5NI5iCVdZ_ZLEFsH6cegLegz0')
					.then(res => res.json())
					.then(json => {
						console.log(json);
