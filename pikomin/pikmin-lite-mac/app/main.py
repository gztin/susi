...
app = FastAPI(title="Pikmin Lite", version="0.1.0", lifespan=lifespan)
...
landmark_images_dir = Path(__file__).resolve().parent / "data" / "images" / "landmarks"
landmark_images_dir.mkdir(parents=True, exist_ok=True)
app.mount(
    "/static/landmark-images",
    StaticFiles(directory=landmark_images_dir),
    name="landmark-images",
)
